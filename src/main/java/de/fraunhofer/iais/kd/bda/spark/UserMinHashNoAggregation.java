...
public class UserMinHashNoAggregation {
	...
	//	String inputFile= "/home/livlab/data/last-fm-sample1000000.tsv";
		...
		JavaPairRDD<String, MinHashAggregator> minHashes = artname2user.aggregateByKey(
				new MinHashAggregator(),
				(agg, user) -> {
					agg.add(user);
					return agg;
				},
		...
		JavaPairRDD<String, String> art2minhash = minHashes.mapToPair(artistMinhashPair -> {
			return new Tuple2<String, String>(artistMinhashPair._1, artistMinhashPair._2.toString());
		});
		
		// Minhash of Mark Knopfler: 665, 967, 554, 143, 326, 922, 90, 686, 863, 625, 222, 993, 165, 759, 944, 704, 468, 57, 828, 0
		art2minhash.saveAsTextFile("resources/artist_to_minhashes_efficient.txt");
		context.close();
